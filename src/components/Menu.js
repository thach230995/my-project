...
function Menu() {
    ...
    return (
        <header className="bg-amber-200 font-bold h-[70px] w-full right-0 max-w-full flex flex-row items-center justify-between relative">
            ...
            <nav className="flex flex-row gap-10 text-sky-700 z-10 relative">
                <ul className="flex flex-row gap-10 text-sky-700 z-10 relative">
                    ...
                    <li><Link to="/ProductSideBarPage" className=" hover:text-blue-400" >Admin</Link></li>
                </ul>
            </nav>
           
            <Search
                size="large"
                className="w-[250px] text-sm mr-2"
